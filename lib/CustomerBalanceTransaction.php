...
class CustomerBalanceTransaction extends ApiResource
{
    ...
    /**
     * Possible string representations of a customer balance transaction's type.
    ...
    const TYPE_RECEIVER_SOURCE_MISPAYMENT = 'receiver_source_mispayment';
    const TYPE_REVERSAL                   = 'reversal';

    /**
     * @return string The API URL for this customer balance transaction.
     */
    public function instanceUrl()
    {
        ...
        $extn = urlencode($id);
        return "$base/$customerExtn/customer_balance_transactions/$extn";
    }
    ...
    public static function retrieve($_id, $_opts = null)
    {
        $msg = "Customer Balance Transactions cannot be accessed without a customer ID. " .
               "Retrieve a Customer Balance Transaction using Customer::retrieveTransaction('transaction_id') instead.";
